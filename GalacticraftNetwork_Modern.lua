...
local function scan()
 ...
 for addr,typ in component.list() do
  ...
  if s:find("galactic") or s:find("rocket") or s:find("oxygen") or s:find("space") or s:find("network") then r[#r+1]={addr,typ} end
 end
 return r
end
while true do
 term.clear();term.setCursor(1,1);print("=== BULDACITY // GALACTICRAFT NETWORK ===");print("Buldacity Network / live OC component discovery");print("")
