...
local function scan()
 ...
 for addr,typ in component.list() do
  ...
  if s:find("gendustry") or s:find("genetic") or s:find("bee") or s:find("apiary") or s:find("network") then r[#r+1]={addr,typ} end
 end
 return r
end
while true do
 term.clear();term.setCursor(1,1);print("=== BULDACITY // GENDUSTRY NETWORK ===");print("Live OpenComputers component discovery");print("")
